    ...
    <div className="container mx-auto px-6 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-10">
          <h2 className="text-2xl font-semibold mb-4" style={{ color: 'var(--color-blue)' }}>Our Story</h2>
          ...
          <h2 className="text-2xl font-semibold mb-4" style={{ color: 'var(--color-blue)' }}>Our Mission</h2>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mb-4" style={{ color: 'var(--color-blue)' }}>Our Team</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="text-center">
                ...
                <h3 className="font-semibold text-lg" style={{ color: 'var(--color-blue)' }}>{member.name}</h3>
